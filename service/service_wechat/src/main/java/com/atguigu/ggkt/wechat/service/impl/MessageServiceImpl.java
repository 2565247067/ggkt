...
public class MessageServiceImpl implements MessageService {
    ...
    public void pushPayMessage(long id) {
        String openid = "oeWbp58hfFsel5dxanGL1mi_-Z3c";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("FVnoEnUSF5TUOd3U-gLoiZ7GdKzyOqnPJdXPV4NK2Ag")//模板id
                .url("http://lhweb.vaiwan.com/#/pay/"+id)//点击模板消息要访问的网址
                .build();
        //3,如果是正式版发送消息，，这里需要配置你的信息
        templateMessage.addData(new WxMpTemplateData("first", "您有一笔订单支付成功（假的假的！！！）。", "#272727"));
    ...
    private String aboutUs(Map<String, String> param) {
        return this.text(param, "其实只有我，一个只想搞钱的男人哈哈哈哈哈").toString();
    }
    ...
    private String subscribe(Map<String, String> param) {
        //处理业务
        return this.text(param, "嘿嘿！！！你来啦！！！！感谢你关注“LH的尚大课堂~~~”，有一说一做的快累死了，不过功能都差不多了哈，可以根据关键字搜索您想看的视频教程，如：JAVA基础、Spring boot、大数据等").toString();
    }
